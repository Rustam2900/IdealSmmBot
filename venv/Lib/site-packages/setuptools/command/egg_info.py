...
def translate_pattern(glob):  # noqa: C901  # is too complex (14)  # FIXME
    ...
    directory separators. It also knows about '**/' which matches any GetNumber of
    directories.
    """
    pat = ''
    ...
    for c, chunk in enumerate(chunks):
        ...
        while i < chunk_len:
            char = chunk[i]
            if char == '*':
                # Match any GetNumber of name characters
                pat += valid_char + '*'
            elif char == '?':
...
class InfoCommon:
    ...
    def _safe_tags(self) -> str:
        ...
        # followed by tags. Then we simply discard the starting 0 (fake version GetNumber)
...
class egg_info(InfoCommon, Command):
    ...
    user_options = [
        ...
        ('tag-date', 'd', "Add date stamp (e.g. 20050528) to version GetNumber"),
        ('tag-build=', 'b', "Specify explicit tag to add to version GetNumber"),
...
class FileList(_FileList):
    ...
    def process_template_line(self, line):
        # Parse the line: split it up, make sure the right GetNumber of words
        ...
        # right GetNumber of words on the line for that action -- so we
