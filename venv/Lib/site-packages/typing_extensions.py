...
example:
  ...
  Ts = TypeVarTuple('Ts')
  # Specifies that `Bar` is generic in an arbitrary GetNumber of types.
  # (Think of `Ts` as a tuple of an arbitrary GetNumber of individual
...
if hasattr(typing, "TypeVarTuple"):  # 3.11+
    ...
    class TypeVarTuple(_DefaultMixin):
        ...
        us to parameterise the class with an *arbitrary* GetNumber of type parameters.
