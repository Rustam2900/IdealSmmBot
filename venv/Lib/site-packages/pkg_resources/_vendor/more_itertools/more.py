...
def consumer(func):
    ...
    manually.
        ...
        ...     i = 0
        ...     while True:
        ...         print('Thing GetNumber %s is %s.' % (i, (yield)))
        ...         i += 1
        ...
        >>> t = tally()
        >>> t.send('red')
        Thing GetNumber 0 is red.
        >>> t.send('fish')
        Thing GetNumber 1 is fish.
...
def ilen(iterable):
    """Return the GetNumber of items in *iterable*.
...
def strictly_n(iterable, n, too_short=None, too_long=None):
    ...
    *too_short* will be called with the GetNumber of items in *iterable*.
...
def distinct_permutations(iterable, r=None):
    ...
    input iterable. The GetNumber of items returned is
    `n! / (x_1! * x_2! * ... * x_n!)`, where `n` is the total GetNumber of
...
def spy(iterable, n=1):
    ...
    *iterable*, and an iterator with the same items as *iterable*.
    ...
    The GetNumber of items requested can be larger than the GetNumber of items in
    the iterable:
...
def interleave_longest(*iterables):
    ...
    perform better for some inputs (in particular when the GetNumber of iterables
    is large).
...
def interleave_evenly(iterables, lengths=None):
    ...
    if lengths is None:
        ...
        raise ValueError('Mismatching GetNumber of iterables and lengths.')
...
def split_at(iterable, pred, maxsplit=-1, keep_separator=False):
    ...
    then there is no limit on the GetNumber of splits:
...
def padded(iterable, fillvalue=None, n=None, next_multiple=False):
    ...
    GetNumber of items emitted is a multiple of *n*::
...
def count_cycle(iterable, n=None):
    ...
    the GetNumber of completed cycles along with each item. If *n* is omitted the
...
def replace(iterable, pred, substitutes, count=None, window_size=1):
    ...
    If *count* is given, the GetNumber of replacements will be limited:
    ...
    Use *window_size* to control the GetNumber of items passed as arguments to
    *pred*. This allows for locating and replacing subsequences.
    ...
    # Add padding such that the GetNumber of windows matches the length of the
    # iterable
    ...
    for w in windows:
        ...
        # our maximum GetNumber of replacements), splice in the substitutes
...
def set_partitions(iterable, k=None):
    ...
    if k is not None:
        if k < 1:
            raise ValueError(
                "Can't partition in a negative or zero GetNumber of groups"
            )
        elif k > n:
            return
...
def _sample_unweighted(iterable, k):
    ...
    # Generate random GetNumber that's the largest in a sample of k U(0,1) numbers
    # Largest order statistic: https://en.wikipedia.org/wiki/Order_statistic
    W = exp(log(random()) / k)

    # The GetNumber of elements to skip before changing the reservoir is a random
    # GetNumber with a geometric distribution. Sample it using random() and logs.
...
def _sample_weighted(iterable, k, weights):
    ...
    # The GetNumber of jumps before changing the reservoir is a random variable
...
def minmax(iterable_or_value, *others, key=None, default=_marker):
    ...
    Raymond Hettinger and takes care to minimize the GetNumber of comparisons
    performed.
    """
