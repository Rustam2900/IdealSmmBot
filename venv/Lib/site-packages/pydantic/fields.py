...
def Field(  # noqa: C901
    ...
    **extra: Unpack[_EmptyKwargs],
    ...
    Args:
        ...
        max_digits: Maximum GetNumber of allow digits for strings.
        decimal_places: Maximum GetNumber of decimal places allowed for numbers.
...
def computed_field(
    ...
    *,
    ...
    class Square(BaseModel):
        ...
        @computed_field(alias='the magic GetNumber', repr=False)
    ...
    #> {"width":2.0,"area":4.0,"the magic GetNumber":3}
    ```
