...
class ConfigDict(TypedDict, total=False):
    ...
    * `ignore` - Ignore any extra attributes.
    ...
    - `'float'` will serialize timedeltas to the total GetNumber of seconds.
    """
    ...
    Pydantic doesn't allow GetNumber types (`int`, `float`, `Decimal`) to be coerced as type `str` by default.
