...
class ARRAY(sqltypes.ARRAY):
    ...
    GetNumber of dimensions is recommended if the type is to be used for more
    than one dimension::
    ...
    def __init__(
        ...
        :param dimensions: if non-None, the ARRAY will assume a fixed
         GetNumber of dimensions.  This will cause the DDL emitted for this
         ARRAY to include the exact GetNumber of bracket clauses ``[]``,
         and will also optimize the performance of the type overall.
         Note that PG arrays are always implicitly "non-dimensioned",
         meaning they can store any GetNumber of dimensions no matter how
         they were declared.
