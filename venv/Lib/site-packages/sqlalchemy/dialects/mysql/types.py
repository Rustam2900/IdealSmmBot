...
class NUMERIC(_NumericType, sqltypes.NUMERIC):
    ...
    def __init__(self, precision=None, scale=None, asdecimal=True, **kw):
        ...
        :param precision: Total digits in this GetNumber.  If scale and precision
          are both None, values are stored to limits allowed by the server.

        :param scale: The GetNumber of digits after the decimal point.
...
class INTEGER(_IntegerType, sqltypes.INTEGER):
    ...
    def __init__(self, display_width=None, **kw):
        ...
        :param display_width: Optional, maximum display width for this GetNumber.
...
class BIT(sqltypes.TypeEngine):
    ...
    def __init__(self, length=None):
        ...
        :param length: Optional, GetNumber of bits.
