...
"compatibility" version, which is a version GetNumber that is independent of the
...
GetNumber of prefix columns to compress, or ``True`` to use the default (all
        ...
        for row_dict in result:
            ...
            if coltype == "NUMBER":
                ...
                if precision == 126:
                    ...
                    # GetNumber with binary precision 126.
                    coltype = DOUBLE_PRECISION()
                elif precision == 63:
                    # The REAL datatype is a floating-point GetNumber with a
