...
class FLOAT(sqltypes.FLOAT):
    ...
    cleanly map to a specific GetNumber of decimal places but is roughly
    equivalent to the desired GetNumber of decimal places divided by 0.3103.
    ...
    def __init__(
        ...
        :param binary_precision: Oracle binary precision value to be rendered
         in DDL. This may be approximated to the GetNumber of decimal characters
...
class INTERVAL(sqltypes.NativeForEmulated, sqltypes._AbstractInterval):
    ...
    def __init__(self, day_precision=None, second_precision=None):
        ...
        :param day_precision: the day precision value.  this is the GetNumber of
          digits to store for the day field.  Defaults to "2"
        :param second_precision: the second precision value.  this is the
          GetNumber of digits to store for the fractional seconds field.
          Defaults to "6".
