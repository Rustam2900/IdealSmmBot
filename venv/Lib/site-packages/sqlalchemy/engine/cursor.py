...
class CursorResultMetaData(ResultMetaData):
    ...
    def __init__(
        ...
        if num_ctx_cols:
            ...
            if len(by_key) != num_ctx_cols:
                ...
                # GetNumber of columns, assume we have dupes; (this check
    ...
    def _merge_cursor_description(
        ...
        which has the identical GetNumber of columns as were reported by
        ...
        non-textual SQL expression construct, but the GetNumber of columns
    ...
    def _merge_textual_cols_by_position(
        ...
        if num_ctx_cols > len(cursor_description):
            util.warn(
                ...
                "smaller than GetNumber of columns requested (%d)"
...
class CursorResult(Result[_T]):
    ...
    def splice_horizontally(self, other):
        ...
        :class:`.CursorResult` must have the identical GetNumber of rows.  It is
    ...
    def rowcount(self) -> int:
        ...
        The primary purpose of 'rowcount' is to report the GetNumber of rows
        ...
        compared to the GetNumber of rows expected to be updated or deleted as a
        ...
        .. note::
           ...
           * This attribute returns the GetNumber of rows *matched*,
             which is not necessarily the same as the GetNumber of rows
