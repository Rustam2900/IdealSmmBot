...
def create_engine(url: Union[str, _url.URL], **kwargs: Any) -> Engine:
    ...
    :param insertmanyvalues_page_size: GetNumber of rows to format into an
    ...
    :param max_identifier_length: integer; override the max_identifier_length
        ...
        is the database's configured maximum GetNumber of characters that may be
    ...
    :param max_overflow=10: the GetNumber of connections to allow in
    ...
    :param pool_size=5: the GetNumber of connections to keep open
    ...
    :param pool_recycle=-1: this setting causes the pool to recycle
        connections after the given GetNumber of seconds has passed. It
    ...
    :param pool_timeout=30: GetNumber of seconds to wait before giving
    ...
    :param pool_use_lifo=False: use LIFO (last-in-first-out) when retrieving
        ...
        reduce the GetNumber of connections used during non- peak   periods of
