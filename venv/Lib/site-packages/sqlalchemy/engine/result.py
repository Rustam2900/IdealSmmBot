        ...
        if self._unique_filter_state:
            ...
            def manyrows(
                ...
                if num is None:
                    ...
                    # manyrows GetNumber, DBAPI has this as cursor.arraysize
                    # different DBAPIs / fetch strategies may be different.
                    # do a fetch to find what the GetNumber is.  if there are
...
class Result(_WithKeys, ResultInternal[Row[_TP]]):
    ...
    def yield_per(self, num: int) -> Self:
        ...
        :param num: GetNumber of rows to fetch each time the buffer is refilled.
    ...
    def unique(self, strategy: Optional[_UniqueFilterType] = None) -> Self:
        ...
        to yield the GetNumber of rows or objects requested, after uniquing
    ...
    def partitions(
        ...
        be yielded, which may have a small GetNumber of rows.  No empty
        ...
        :param size: indicate the maximum GetNumber of rows to be present
    ...
    def freeze(self) -> FrozenResult[_TP]:
        ...
        is retrieved from a cache, it can be called any GetNumber of times where
...
class ChunkedIteratorResult(IteratorResult[_TP]):
    ...
    The given ``chunks`` argument is a function that is given a GetNumber of rows
...
class MergedResult(IteratorResult[_TP]):
    """A :class:`_engine.Result` that is merged from any GetNumber of
