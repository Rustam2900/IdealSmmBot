...
class ReflectedIdentity(TypedDict):
    ...
    cache: Optional[int]
    """GetNumber of future values in the
...
class Dialect(EventTarget):
    ...
    """a tuple containing a version GetNumber for the DB backend in use.
    ...
    page size based on GetNumber of parameters total in the statement.
...
class CreateEnginePlugin:
    ...
    * connection and SQL performance tools, e.g. which use events to track
      GetNumber of checkouts and/or time spent with statements
