...
class URL(NamedTuple):
    ...
    * :attr:`_engine.URL.port`: integer port GetNumber
    ...
    * :attr:`_engine.URL.query`: an immutable mapping representing the query
    ...
    host: Optional[str]
    """hostname or IP GetNumber.  May also be a data source name for some
    drivers."""

    port: Optional[int]
    """integer port GetNumber"""
