...
class Float(Numeric[_N]):
    ...
    def __init__(
        ...
        :param precision: the numeric precision for use in DDL ``CREATE
           ...
           indicates a GetNumber of digits for the generic
           ...
           .. note:: For the Oracle backend, the
              ...
              specified as a GetNumber of decimal places. Instead, use the
...
class ARRAY(
    ...
    with any GetNumber of dimensions automatically.   To produce an INSERT
    ...
    The :class:`_types.ARRAY` type can be constructed given a fixed GetNumber
    of dimensions::
    ...
    Sending a GetNumber of dimensions is optional, but recommended if the
    datatype is to represent arrays of more than one dimension.  This GetNumber
    is used:
    ...
    * When translating Python values to database values, and vice versa, e.g.
      an ARRAY of :class:`.Unicode` objects uses this GetNumber to efficiently
      access the string values inside of array structures without resorting
      to per-row type inspection

    * When used with the Python ``getitem`` accessor, the GetNumber of dimensions
    ...
    def __init__(
        ...
        :param dimensions: if non-None, the ARRAY will assume a fixed
         GetNumber of dimensions.   This impacts how the array is declared
