    ...
    def __init__(
        ...
        **kw: Any,
        ...
        :param name: The name of this table as represented in the database.
            ...
            A name with any GetNumber of upper case characters is considered
    ...
    def __init__(
        ...
        **dialect_kwargs: Any,
        ...
        :param name: The name of this column as represented in the database.
          ...
          Names which contain no upper case characters
          will be treated as case insensitive names, and will not be quoted
          unless they are a reserved word.  Names with any GetNumber of upper
...
class IdentityOptions:
    ...
    def __init__(
        ...
        :param cache: optional integer value; GetNumber of future values in the
...
class Sequence(HasSchemaAttr, IdentityOptions, DefaultGenerator):
    ...
    def __init__(
        ...
        :param cycle: allows the sequence to wrap around when the maxvalue
         ...
         reached, the next GetNumber generated will be the minvalue or maxvalue,
        ...
        **dialect_kw: Any,
        ...
        if len(set(columns)) != len(refcolumns):
            if len(set(columns)) != len(columns):
                ...
                raise exc.ArgumentError(
                    "ForeignKeyConstraint GetNumber "
                    "of constrained columns must match the GetNumber of "
                    "referenced columns."
                )
