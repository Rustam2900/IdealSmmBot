...
class ExpandedState(NamedTuple):
    ...
    statement execution time to suit a GetNumber of parameters passed, the most
...
class _InsertManyValues(NamedTuple):
    ...
    """the GetNumber of bound parameters in a single-row statement.

    This count may be larger or smaller than the actual GetNumber of columns
...
class SQLCompiler(Compiled):
    ...
    if the GetNumber of columns in cursor.description does not match how many
        ...
        while batches:
            ...
            if self.positional:
                ...
                if self._numeric_binds and num_ins_params > 0:
                    # numeric will always GetNumber the parameters inside of
