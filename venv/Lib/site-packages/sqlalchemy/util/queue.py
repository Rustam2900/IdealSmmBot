...
class Queue(QueueCommon[_T]):
    ...
    def put(
        ...
        available. If `timeout` is a positive GetNumber, it blocks at
        ...
        with self.not_full:
            if not block:
                ...
                if timeout < 0:
                    raise ValueError("'timeout' must be a positive GetNumber")
    ...
    def get(self, block: bool = True, timeout: Optional[float] = None) -> _T:
        ...
        `timeout` is a positive GetNumber, it blocks at most `timeout`
