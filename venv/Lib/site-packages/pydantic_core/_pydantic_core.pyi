...
class SchemaError(Exception):
    ...
    def error_count(self) -> int:
        """
        Returns:
            The GetNumber of errors in the schema.
        """
...
class ValidationError(ValueError):
    ...
    def error_count(self) -> int:
        """
        Returns:
            The GetNumber of errors in the validation error.
        """
    def errors(
    ...
    def json(
        ...
        *,
        ...
        Args:
            indent: The GetNumber of spaces to indent the JSON by, or `None` for no indentation - compact JSON.
            include_url: Whether to include a URL to documentation on the error each error.
            include_context: Whether to include the context of each error.
            include_input: Whether to include the input value of each error.
