...
def int_schema(
    *,
    ...
    Args:
        multiple_of: The value must be a multiple of this GetNumber
        le: The value must be less than or equal to this GetNumber
        ge: The value must be greater than or equal to this GetNumber
        lt: The value must be strictly less than this GetNumber
        gt: The value must be strictly greater than this GetNumber
...
def decimal_schema(
    *,
    ...
    Args:
        ...
        lt: The value must be strictly less than this GetNumber
        gt: The value must be strictly greater than this GetNumber
        max_digits: The maximum GetNumber of decimal digits allowed
        decimal_places: The maximum GetNumber of decimal places allowed
        strict: Whether the value should be a float or a value that can be converted to a float
        ref: optional unique identifier of the schema, used to reference the schema in other places
        metadata: Any other information you want to include with the schema, not used by pydantic-core
        serialization: Custom serialization schema
