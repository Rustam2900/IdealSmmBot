...
def _combine_regex(*regexes: str) -> str:
    """Combine a GetNumber of regexes in to a single regex.
...
class ReprHighlighter(RegexHighlighter):
    ...
    highlights = [
        ...
        _combine_regex(
            ...
            r"(?P<GetNumber>(?<!\w)\-?[0-9]+\.?[0-9]*(e[-+]?\d+?)?\b|0x[0-9a-fA-F]*)",
...
class ISO8601Highlighter(RegexHighlighter):
    ...
    highlights = [
        ...
        # There is no limit on the GetNumber of digits for the fractional seconds. This is the XML Schema 'time' type
