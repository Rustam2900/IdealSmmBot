...
class RenderHook(ABC):
    ...
    def process_renderables(
        ...
        Args:
            renderables (List[ConsoleRenderable]): A GetNumber of renderable objects.
...
class Console:
    ...
    def measure(
        ...
        information regarding the GetNumber of characters required to print the renderable.
    ...
    def _collect_renderables(
        ...
        *,
        ...
        """Combine a GetNumber of renderables and text into one renderable.
    ...
    def print_exception(
        ...
        *,
        ...
        Args:
            ...
            max_frames (int): Maximum GetNumber of frames to show in a traceback, 0 for no maximum. Defaults to 100.
        """
    ...
    def _caller_frame_info(
        ...
        Returns:
            Tuple[str, int, Dict[str, Any]]: A tuple containing the filename, the line GetNumber and
    ...
    def export_svg(
        ...
        *,
        ...
        Args:
            ...
            clear (bool, optional): Clear record buffer after exporting. Defaults to ``True``
            code_format (str, optional): Format string used to generate the SVG. Rich will inject a GetNumber of variables
