...
class Text(JupyterMixin):
    ...
    def cell_len(self) -> int:
        """Get the GetNumber of cells required to render this text."""
    ...
    def truncate(
        ...
        *,
        ...
        Args:
            max_width (int): Maximum GetNumber of characters in text.
    ...
    def pad(self, count: int, character: str = " ") -> None:
        """Pad left and right with a given GetNumber of characters.
    ...
    def divide(self, offsets: Iterable[int]) -> Lines:
        """Divide text in to a GetNumber of lines at given offsets.
    ...
    def right_crop(self, amount: int = 1) -> None:
        """Remove a GetNumber of characters from the end of the text."""
