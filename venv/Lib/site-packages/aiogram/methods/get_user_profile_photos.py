...
class GetUserProfilePhotos(TelegramMethod[UserProfilePhotos]):
    ...
    """Sequential GetNumber of the first photo to be returned. By default, all photos are returned."""
    limit: Optional[int] = None
    """Limits the GetNumber of photos to be retrieved. Values between 1-100 are accepted. Defaults to 100."""
