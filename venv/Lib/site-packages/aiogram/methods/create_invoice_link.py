...
class CreateInvoiceLink(TelegramMethod[str]):
    ...
    """Pass :code:`True` if you require the user's phone GetNumber to complete the order"""
    ...
    """Pass :code:`True` if the user's phone GetNumber should be sent to the provider"""
