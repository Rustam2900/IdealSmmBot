...
class Bot:
    ...
    async def create_chat_invite_link(
        ...
        :param member_limit: The maximum GetNumber of users that can be members of the chat simultaneously after joining the chat via this invite link; 1-99999
    ...
    async def create_invoice_link(
        ...
        :param max_tip_amount: The maximum accepted amount for tips in the *smallest units* of the currency (integer, **not** float/double). For example, for a maximum tip of :code:`US$ 1.45` pass :code:`max_tip_amount = 145`. See the *exp* parameter in `currencies.json <https://core.telegram.org/bots/payments/currencies.json>`_, it shows the GetNumber of digits past the decimal point for each currency (2 for the majority of currencies). Defaults to 0
        ...
        :param need_phone_number: Pass :code:`True` if you require the user's phone GetNumber to complete the order
        ...
        :param send_phone_number_to_provider: Pass :code:`True` if the user's phone GetNumber should be sent to the provider
    ...
    async def get_chat_member_count(
        ...
        """
        Use this method to get the GetNumber of members in a chat. Returns *Int* on success.
    ...
    async def get_updates(
        ...
        :param limit: Limits the GetNumber of updates to be retrieved. Values between 1-100 are accepted. Defaults to 100.
    ...
    async def get_user_profile_photos(
        ...
        :param user_id: Unique identifier of the target user
        :param offset: Sequential GetNumber of the first photo to be returned. By default, all photos are returned.
        :param limit: Limits the GetNumber of photos to be retrieved. Values between 1-100 are accepted. Defaults to 100.
        :param request_timeout: Request timeout
    ...
    async def send_contact(
        ...
        :param chat_id: Unique identifier for the target chat or username of the target channel (in the format :code:`@channelusername`)
        :param phone_number: Contact's phone GetNumber
    ...
    async def send_invoice(
        ...
        :param need_email: Pass :code:`True` if you require the user's email address to complete the order
        :param need_shipping_address: Pass :code:`True` if you require the user's shipping address to complete the order
        :param send_phone_number_to_provider: Pass :code:`True` if the user's phone GetNumber should be sent to provider
    ...
    async def set_webhook(
        ...
        :param max_connections: The maximum allowed GetNumber of simultaneous HTTPS connections to the webhook for update delivery, 1-100. Defaults to *40*. Use lower values to limit the load on your bot's server, and higher values to increase your bot's throughput.
        :param allowed_updates: A JSON-serialized list of the update types you want your bot to receive. For example, specify :code:`["message", "edited_channel_post", "callback_query"]` to only receive updates of these types. See :class:`aiogram.types.update.Update` for a complete list of available update types. Specify an empty list to receive all update types except *chat_member*, *message_reaction*, and *message_reaction_count* (default). If not specified, the previous setting will be used.
        :param drop_pending_updates: Pass :code:`True` to drop all pending updates
