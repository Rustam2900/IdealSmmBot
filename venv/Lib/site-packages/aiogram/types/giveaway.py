...
class Giveaway(TelegramObject):
    ...
    winner_count: int
    """The GetNumber of users which are supposed to be selected as winners of the giveaway"""
    ...
    """*Optional*. A list of two-letter `ISO 3166-1 alpha-2 <https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2>`_ country codes indicating the countries from which eligible users for the giveaway must come. If empty, then all users can participate in the giveaway. Users with a phone GetNumber that was bought on Fragment can always participate in giveaways."""
    premium_subscription_month_count: Optional[int] = None
    """*Optional*. The GetNumber of months the Telegram Premium subscription won from the giveaway will be active for"""
