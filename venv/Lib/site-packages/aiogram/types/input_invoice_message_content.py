...
class InputInvoiceMessageContent(InputMessageContent):
    ...
    """*Optional*. Pass :code:`True` if you require the user's phone GetNumber to complete the order"""
    ...
    """*Optional*. Pass :code:`True` if the user's phone GetNumber should be sent to provider"""
